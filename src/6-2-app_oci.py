...
# ---------------------------------------------------------
# Load MCPClient from '6-2-client.py'
# ---------------------------------------------------------
current_dir = os.path.dirname(os.path.abspath(__file__))
client_module_path = os.path.join(current_dir, "6-2-client.py")
server_script_path = os.path.join(current_dir, "6-2-server.py")
...
def main():
    ...
    def notification_handler(data):
        ...
        if method == "notifications/message":
             ...
             print(f"[Details] {message_data}") # Using a different prefix for OCI App
        else:
             print(f"[Notification] {method}: {params}")

    # 3. Init MCPClient
    print("Initializing MCP Client...")
    mcp_client = MCPClient(server_script_path, notification_handler=notification_handler)
